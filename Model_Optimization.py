...
class _Optimization():
    ...
    def __init__(self, l1_dense_layers=300, l2_dense_layers=300,
                 l3_dense_layers=300,
                 l4_dense_layers = 300,
                 l5_dense_layers = 300,
        ...
        self.l2_dense_layers = l2_dense_layers
        self.l3_dense_layers = l3_dense_layers
        self.l4_dense_layers = l4_dense_layers
        self.l5_dense_layers = l5_dense_layers
...
def run_(validation_split=0.3, l1_dense_layers=300, l2_dense_layers=300,
                 l3_dense_layers=300,
                 l4_dense_layers = 300,
                 l5_dense_layers = 300,
                 batch_size=32):
    ...
    _optimize = _Optimization(l1_dense_layers=l1_dense_layers, l2_dense_layers=l2_dense_layers,
                                    l3_dense_layers=l3_dense_layers, l4_dense_layers=l4_dense_layers,
                                    l5_dense_layers=l5_dense_layers, batch_size=int(batch_size),
...
bounds = [{'name': 'validation_split', 'type': 'continuous', 'domain': (0.2, 0.8)},
          {'name': 'l1_dense_layers', 'type': 'discrete', 'domain': (200, 300, 500, 1000, 1500, 2000, 2500, 3000)},
          {'name': 'l2_dense_layers', 'type': 'discrete', 'domain': (200, 300, 500, 1000, 1500, 2000, 2500, 3000)},
          {'name': 'l3_dense_layers', 'type': 'discrete', 'domain': (200, 300, 500, 1000, 1500, 2000, 2500, 3000)},
          {'name': 'l4_dense_layers', 'type': 'discrete', 'domain': (200, 300, 500, 1000, 1500, 2000, 2500, 3000)},
          {'name': 'l5_dense_layers', 'type': 'discrete', 'domain': (200, 300, 500, 1000, 1500, 2000, 2500, 3000)},
          {'name': 'batch_size', 'type': 'discrete', 'domain': (20, 32, 64, 100, 125)},]
...
def f(x):
    ...
    evaluation = run_(
        ...
        l2_dense_layers=int(x[:, 2]),
        l3_dense_layers=int(x[:, 3]),
        l4_dense_layers=int(x[:, 4]),
        l5_dense_layers=int(x[:, 5]),
        batch_size=int(x[:, 6]),)
       # epochs=int(x[:, 7]))
    ...
    print("l2_dense_layers : ", int(x[:, 2]))
    print("l3_dense_layers : ", int(x[:, 3]))
    print("l4_dense_layers : ", int(x[:, 4]))
    print("l5_dense_layers : ", int(x[:, 5]))
    print("batch_size : ", int(x[:, 6]))
...
d = {'Loss': [opt_model.fx_opt], 'Validation Split': [opt_model.x_opt[0]], 'Layer 1': [opt_model.x_opt[1]],
         'Layer 2': [opt_model.x_opt[2]],
         'Layer 3': [opt_model.x_opt[3]], 'Layer 4': [opt_model.x_opt[4]], 'Layer 5': [opt_model.x_opt[5]],
         'Batch Size': [opt_model.x_opt[6]]}
